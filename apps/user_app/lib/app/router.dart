...
class AppRouter {
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    ...
    return switch (settings.name) {
      ...
      Routes.member => _page(const MemberCenterPage(), settings),
      ...
      Routes.couponSelector => _page(
        CouponSelectorPage(orderAmount: _couponOrderAmount(settings.arguments)),
        settings,
      ),
  ...
  static double _couponOrderAmount(Object? args) => switch (args) {
