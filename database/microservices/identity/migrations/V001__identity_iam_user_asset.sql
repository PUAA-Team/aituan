...
CREATE INDEX idx_user_address_user_default ON user_address (user_id, is_default, is_deleted);
CREATE INDEX idx_user_favorite_user_type ON user_favorite (user_id, favorite_type, is_deleted);
