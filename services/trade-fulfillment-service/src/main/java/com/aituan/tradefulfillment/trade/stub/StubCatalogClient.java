...
public class StubCatalogClient implements CatalogClient {
  ...
  private static final Map<Long, ItemSnapshot> ITEMS = Map.of(
      1001L, new ItemSnapshot(1001L, 1001L, 1L, "香辣鸡腿堡", "经典微辣", "takeaway", 10L, "汉堡", new BigDecimal("18.80"), "on_sale", 30, null),
      1002L, new ItemSnapshot(1002L, 1002L, 1L, "吮指原味鸡", "两块装", "takeaway", 11L, "炸鸡", new BigDecimal("19.90"), "on_sale", 50, null),
      1003L, new ItemSnapshot(1003L, 1003L, 1L, "停售测试商品", "不可购买", "takeaway", 11L, "炸鸡", new BigDecimal("9.90"), "off_sale", 0, null),
      2001L, new ItemSnapshot(2001L, 2001L, 2L, "双人桌游体验券", "周末通用", "group_buy", 20L, "休闲娱乐", new BigDecimal("68.00"), "on_sale", 20, null));
