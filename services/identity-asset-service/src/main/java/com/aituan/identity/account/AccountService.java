...
import com.aituan.identity.file.FileAssetView;
import com.aituan.identity.file.FileStorageService;
...
import com.aituan.identity.client.MapDistanceService;
...
class AccountService {
  ...
  AccountService(
      ...
      TradeMetricsClient tradeMetricsClient) {
  ...
  AccountProfileView profile() {
    ...
    return new AccountProfileView(
        ...
        tradeMetricsClient.countUserOrders(currentUser.userId()),
